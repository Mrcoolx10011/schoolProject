...
const Careers = () => {
  return (
    <PageContainer>
      <Title>Careers at Samyak Global Academy</Title>

      <Section>
        <Text>
          Join our dedicated team of educators and staff who are passionate about shaping the future. Samyak Global Academy offers a vibrant and supportive work environment with opportunities for professional growth and development.
        </Text>
        <Text>
          We are always looking for talented individuals who share our commitment to excellence and innovation in education. Explore our current openings and become a part of the Samyak family!
        </Text>
      </Section>
      ...
      <Section>
        ...
        <Grid style={{ marginTop: '1.5rem' }}>
          <JobCard>
            ...
            <Button as="a" href="mailto:careers@samyakglobalacademy.edu?subject=Application for Primary School Teacher">Apply Now</Button>
          </JobCard>
          <JobCard>
            ...
            <Button as="a" href="mailto:careers@samyakglobalacademy.edu?subject=Application for Secondary School Science Teacher">Apply Now</Button>
          </JobCard>
          <JobCard>
            ...
            <Button as="a" href="mailto:careers@samyakglobalacademy.edu?subject=Application for Admissions Counselor">Apply Now</Button>
          </JobCard>
          <JobCard>
            <h3>Sports Coach</h3>
            <p className="location">Location: Education City, India</p>
            ...
            <Button as="a" href="mailto:careers@samyakglobalacademy.edu?subject=Application for Sports Coach">Apply Now</Button>
          </JobCard>
        </Grid>
      </Section>
